...
public class FileDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public Builder setFileSelectListener(FileDialogListener fileSelectListener) {
            this.fileSelectListener = fileSelectListener;
            return this;
        }

        /**
         * 必须强制设置dialog的大小。dialog.getWidow.setLayout(w,h)
         * 
         * @return
         */
            ...
            okButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (fileSelectListener != null) {
                        fileSelectListener.onFileSelected(dialogView.getSelectedFiles());
                        dialog.dismiss();
                    }
                }
            });
